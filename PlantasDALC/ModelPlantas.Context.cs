...
namespace PlantasDALC
{
    ...
    public partial class PlantasEntities : DbContext
    {
        public PlantasEntities()
            : base("name=PlantasEntities")
        {
        }
        ...
        public virtual ObjectResult<Nullable<int>> spObtenerCantidadAutoctonas()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spObtenerCantidadAutoctonas");
        }
    
        public virtual ObjectResult<Nullable<int>> spObtenerCantidadVenenosas()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spObtenerCantidadVenenosas");
        }
